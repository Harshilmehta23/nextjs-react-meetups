...
// CONCATENATED MODULE: ./pages/[meetupId]/index.js
 ...
 // our-domain.com/new-meetup/meetup-1
...
async function getStaticPaths() {
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://meetup:IiwkHALZuffZoV9l@cluster0.c8imr.mongodb.net/meetups?retryWrites=true&w=majority");
  const db = client.db();
